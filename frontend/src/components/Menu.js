...
class Menu extends Component {
    ...
    render() {
        ...
        return (
            <div className="border-2 border-white w-[220px] h-screen text-white">
                ...
                <div className="flex gap-5 pl-8 py-3 cursor-pointer hover:bg-gray-500 border-b-2 border-gray-500">
                    <BsPeople size={20} />
                    <span>Liên hệ</span>
                </div>
                <div className="flex gap-5 pl-8 py-3 cursor-pointer hover:bg-gray-500">
